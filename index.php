...
<html lang="es">
	...
	<body>
		...
		<div class='container'>
			...
			<div id="rotulo">
				<h1> RESTAURANTE PHRANCIX-R </h1>
				<h3> Comidas caseras </h3>
				<hr>
			</div>
			
			<div id='pizarra'>
				<h2> Menú del Día: 18€ </h2>
			
				<br>
				<h3> Primeros </h3>
					<?php consulta_lista($consulta_primeros) ?>
				<br>
				<h3> Segundos </h3>
					<?php consulta_lista($consulta_segundos) ?>
				<br>
				<h3> Postres </h3>
					<?php consulta_lista($consulta_postres) ?>
				<br>
				<h3> Incluido </h3>
				Pan, Bebida, Café
				<br>
